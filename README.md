...
storageOptions.waitUntilSavedTimeout | - | OK | Time to wait for image/video to be saved to the Camera Roll before timing out and returning an error. Default is 30 seconds.
